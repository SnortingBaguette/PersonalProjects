...
public class CameraMovement : MonoBehaviour
{
    ...
    void Update()
    {
        cursorCoordinates.x = (Input.mousePosition.x - 960) / 960;  //Clamp the cursor coordinates to 1
        cursorCoordinates.y = (Input.mousePosition.y - 590) / 590;  //Clamp the cursor coordinates to 1
